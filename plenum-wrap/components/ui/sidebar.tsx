      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              // FIX: Changed `min-h-svh` to `h-full` to ensure the wrapper correctly takes full height
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            // FIX: Changed `h-svh` to `h-full` to ensure the fixed sidebar takes full parent height
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      data-sidebar="inset" // Added data-sidebar="inset" for styling
      className={cn(
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      // FIX: Ensure SidebarContent can scroll its own content if it overflows
      // min-h-0 is crucial for flex items to shrink correctly
      className={cn(
